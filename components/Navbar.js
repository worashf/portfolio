...
const Navbar = () => {
  ...
  return (
    <div className="max-h-screen md:sticky md:top-0 z-50 text-white ">
      {/* MOBILE SIDEBAR */}
      <div className="bg-sky-800 flex justify-between p-2 items-center sticky top-0 z-30 ">
        <div className="block text-white font-extrabold dark:text-dw ">
          <div className="flex flex-row w-full items-center  rounded py-2.5  space-x-2 hover:text-white transition duration-200">
      ...
      <div
        ref={sideBarRef}
        className=" overflow-y-scroll bg-sky-800 w-full space-y-10 px-5 py-7  absolute inset-y-0 left-0 transform -translate-x-full
