    ...
    >
      ...
      <div className="flex flex-row w-full items-center  rounded py-2.5 my-20 space-x-2 hover:text-white transition duration-200">
        <div className="hover:bg-blue-600 p-1">
          <Link href="https://www.facebook.com/profile.php?id=100006018075352">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="hover:bg-blue-600 p-1">
          <Link href="https://twitter.com/WorashAboche">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="hover:bg-blue-600  p-1">
          <Link href="https://github.com/worashf/">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
        ...
        <div className="hover:bg-blue-600  p-1">
          <Link href=" https://www.linkedin.com/in/worash-abocherugn/">
            <svg
              className="w-5 h-5 "
