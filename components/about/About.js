      ...
      <div className="flex flex-col w-full space-y-5 justify-between w-full space-x-5 md:flex-row md:space-y-0 mt-0 pt-0">
        ...
        <div class=" w-full  rounded-lg shadow-md ">
          <a href="#">
            ...
            Hi there! I am Worash, and I am a full-stack developer who loves building applications that live on the internet. I find it incredibly satisfying to create something that people can use and enjoy, and I am always looking for new ways to push the boundaries of what&apos;s possible.
            </h5>
          </a>
